...
# ابزار های ویدئویی و صوتی
 - ~~تولید عکس با متن ( رایگان و مقدماتی )~~ (بار ها این بخش رو نشون دادیم، نیازی به ارائه مجدد نیست)
 - ~~تبدیل عکس به متن ( توصیف یک عکس )~~ (در ویدئو همین فولدر)
 - ~~حذف بک گراند یک عکس~~ (در ویدئو همین فولدر)
 - ~~حذف یک آبجکت از عکس ( آدم یا درخت یا ماشین )~~ (در ویدئو موکاپ در بخش محصول)
 - ~~بلار کردن یک عکس~~ (در ویدئو موکاپ در بخش محصول)
 - ~~تبدیل یک عکس به عکس دیگه ( مثل تبدیل عکس واقعی به یک آرت )~~ (در ویدئو همین فولدر)
 - بهبود رنگ یک عکس
 - رنگی کردن عکس قدیمی
 - بزرگ کردن عکس ( اکستند )
 - ساخت عکس پروفایل
 - تغییر صدا
 - ~~حذف نویز از صدا~~ (در ویدئو همین فولدر)
 - بهبود کیفیت صدا بی کیفیت
 - ~~ایجاد پادکست ( متن به صدا )~~ (در ویدئو همین فولدر)
...
# برنامه نویسی
 ...
 - ~~رفع باگ در یک بخش از کد~~ (ویدئو داخل همین فولدر)
 - ~~بهتر کردن یک بخش از کد~~ (ویدئو داخل همین فولدر)
 - نوشتن کد با ابزار Github Copilot ( در صورت امکان )
 - ~~کراول کردن یک وب سایت~~ (ویدئو داخل همین فولدر)
